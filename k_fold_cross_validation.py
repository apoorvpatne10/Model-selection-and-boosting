...
classifier = SVC(C = 10, kernel = 'rbf', gamma = 0.4, random_state = 0)
...
# Applying grid search to find out the best model and the best parameters
...
# best parameters : C = 10, gamma = 0.4, kernel = rbf
